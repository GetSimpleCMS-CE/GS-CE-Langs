...
$i18n = [
    ...
    */
    ...
    'LATEST_VERSION' => "Laatst ge&iuml;nstalleerde versie",
    ...
    */
    ...
    'SHOW_PLUGINS' => "Ge&iuml;nstalleerde plugins",
	...
	***********************************************************************************/
	...
	// salt-shaker
	"Security_Generator" 	=> 'CE Beveiligingszout/Hash Generator',
	"More_info" 			=> 'Meer informatie beschikbaar in de',
	"Wiki" 					=> 'Wiki',
	"Security_Notice" 		=> 'Beveiligingsmededeling',
	"Tokens_are_never" 		=> 'Tokens worden nooit weergegeven en worden onmiddellijk na verwerking gewist.',
	"Password_Hash" 		=> 'Wachtwoord-Hash',
	"Custom_Salt_Hash" 		=> 'Aangepast Zout-Hash',
	"Password_Hashing" 		=> 'Wachtwoord-Hashing',
	"Used_to_enhance" 		=> 'Gebruikt om de beveiliging van gebruikerswachtwoorden te verbeteren. U moet alle wachtwoorden resetten zodra dit is toegevoegd.',
	"Password_Token" 		=> 'Wachtwoord-Token',
	"Any_word" 				=> 'Elk woord dat u kiest...',
	"Random_string" 		=> 'Willekeurige reeks inclusief tekens en symbolen...',
	"System_Salt" 			=> 'Systeemzout',
	"Generate" 				=> 'Genereren',
	"Security_Hashing" 		=> 'Beveiligings-Hashing',
	"enhance_system_wide" 	=> 'Gebruikt om de beveiliging van het hele systeem te verbeteren, inclusief:',
	"temporary_files" 		=> 'Cookies/tijdelijke bestanden, sessie reset, CSRF-bescherming, bestandsuploads, etc.',
	"Input_Token" 			=> 'Invoer-Token',
	"Application_Salt" 		=> 'Applicatiezout',
	"Generate_Hashes" 		=> 'Hashes Genereren',
	"Password_Hash_Results" => 'Wachtwoord-Hash Resultaten',
	"hidden" 				=> 'verborgen',
	"SHA1_of_Salt" 			=> 'SHA1 van Zout',
	"Your_Hash" 			=> 'Uw \'GSLOGINSALT\'-Hash',
	"hash_copied" 			=> 'hash gekopieerd!',
	"Remain_logged" 		=> 'Blijf ingelogd op uw beheerdersaccount.',
	"Add_hash_GSLOGINSALT" 	=> 'Voeg de nieuwe hash toe aan uw \'GSLOGINSALT\'-veld in gsconfig.php.',
	"Update_all" 			=> 'Update alle gebruikerswachtwoorden.',
	"Custom_Salt" 			=> 'Aangepast Zout-Hash Resultaten',
	"SHA1_of_Application" 	=> 'SHA1 van Applicatiezout',
	"Your_Custome_Hash" 	=> 'Uw \'GSUSECUSTOMSALT\'-Hash',

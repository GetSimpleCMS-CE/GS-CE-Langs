...
$i18n = [
     ...
     * For: install.php
    */
"PHPVER_ERROR"        => "<b>Installation kann nicht fortgesetzt werden:</b> PHP 7.4 oder höher wird benötigt, Sie haben",
...
"API_CONFIRM"          => "SIND SIE SICHER?",
	...
	// salt-shaker
	"Security_Generator" 	=> 'CE Sicherheits-Salt/Hash-Generator',
	"More_info" 			=> 'Weitere Informationen finden Sie im',
	"Wiki" 					=> 'Wiki',
	"Security_Notice" 		=> 'Sicherheitshinweis',
	"Tokens_are_never" 		=> 'Tokens werden niemals angezeigt und sofort nach der Verarbeitung gelöscht.',
	"Password_Hash" 		=> 'Passwort-Hash',
	"Custom_Salt_Hash" 		=> 'Benutzerdefinierter Salt-Hash',
	"Password_Hashing" 		=> 'Passwort-Hashing',
	"Used_to_enhance" 		=> 'Wird verwendet, um die Sicherheit von Benutzerpasswörtern zu erhöhen. Sie müssen alle Passwörter zurücksetzen, sobald dies hinzugefügt wird.',
	"Password_Token" 		=> 'Passwort-Token',
	"Any_word" 				=> 'Beliebiges Wort Ihrer Wahl...',
	"Random_string" 		=> 'Zufällige Zeichenkette mit Zeichen und Symbolen...',
	"System_Salt" 			=> 'System-Salt',
	"Generate" 				=> 'Generieren',
	"Security_Hashing" 		=> 'Sicherheits-Hashing',
	"enhance_system_wide" 	=> 'Wird verwendet, um die systemweite Sicherheit zu erhöhen, einschließlich:',
	"temporary_files" 		=> 'Cookies/temporäre Dateien, Session-Reset, CSRF-Schutz, Datei-Uploads usw.',
	"Input_Token" 			=> 'Eingabe-Token',
	"Application_Salt" 		=> 'Anwendungs-Salt',
	"Generate_Hashes" 		=> 'Hashes generieren',
	"Password_Hash_Results" => 'Passwort-Hash-Ergebnisse',
	"hidden" 				=> 'versteckt',
	"SHA1_of_Salt" 			=> 'SHA1 des Salzes',
	"Your_Hash" 			=> 'Ihr \'GSLOGINSALT\'-Hash',
	"hash_copied" 			=> 'Hash kopiert!',
	"Remain_logged" 		=> 'In Ihrem Administratorkonto angemeldet bleiben.',
	"Add_hash_GSLOGINSALT" 	=> 'Fügen Sie den neuen Hash zu Ihrem \'GSLOGINSALT\'-Feld in gsconfig.php hinzu.',
	"Update_all" 			=> 'Alle Benutzerpasswörter aktualisieren.',
	"Custom_Salt" 			=> 'Benutzerdefinierte Salt-Hash-Ergebnisse',
	"SHA1_of_Application" 	=> 'SHA1 des Anwendungs-Salzes',
	"Your_Custome_Hash" 	=> 'Ihr \'GSUSECUSTOMSALT\'-Hash',
	"Add_hash_GSUSECUSTOMSALT" 	=> 'Fügen Sie den neuen Hash zu Ihrem \'GSUSECUSTOMSALT\'-Feld in gsconfig.php hinzu.',

...
$i18n = [
     ...
     * For: install.php
    */
    "PHPVER_ERROR"			=>	"L'installation ne peut pas se poursuivre :</b> une version de PHP égale ou supérieure &#224; 5.2 est requise - version actuellement installée: ",
    ...
    */
    ...
    "VIEW"					=>	"Afficher",
    "PAGE_OPTIONS"			=>	"Optio<em>n</em>s",
    "SLUG_URL"				=>	"Identifiant / URL (Slug)",
    ...
    */
	...
	"ASK_CANCEL"			=>	"Annuler", // 'c' is the accesskey identifier
	"ASK_RESTORE"			=>	"<em>R</em>estaurer", // 'r' is the accesskey identifier
	"ASK_DELETE"			=>	"Supprimer", // 'd' is the accesskey identifier
	...
	*/
	...
	"TAB_FILES"				=>	"F<em>i</em>chiers",
	"TAB_THEME"				=>	"<em>T</em>hèmes",
	"TAB_BACKUPS"			=>	"<em>B</em>ackups",
	"PLUGINS_NAV" 			=>  "Sauve<em>g</em>ardes",
    ...
    */
    ...
    "SIDE_VIEW_LOG"			=>	"<em>V</em>oir les Log",
    ...
    */
    ...
    "SIDE_EDIT_THEME"		=>	"Modifier le t<em>h</em>ème",
    ...
    */
    ...
    "ER_BAKUP_DELETED"		=>	"La sauvegarde de <b>%s</b> a été supprimée",
    "ER_REQ_PROC_FAIL"		=>	"Erreur dans le traitement de la requête",
    "ER_YOUR_CHANGES"		=>	"Les modifications du fichier <b>%s</b> ont été enregistrées",
    "ER_HASBEEN_REST"		=>	"<b>%s</b> a été restaurée",
    "ER_HASBEEN_DEL"		=>	"<b>%s</b> a été supprimée",
    ...
    "ER_PROBLEM_DEL"		=>	"Vos composants ont été enregistrés",
	...
	*/
	...
	"DATE_AND_TIME_FORMAT"	=>	"j M Y - H:i", //date and time
	...
	***********************************************************************************/
    ...
    "BETA"					=> "Beta / Avant garde",

	/*
	 * Misc Cleanup Work
	 */
	# new to 3.0 
	"HOMEPAGE_DELETE_ERROR" => "Vous ne pouvez pas supprimer votre page d'accueil (homepage)", //deletefile
	"NO_ZIPARCHIVE" 		=> "L'extension ZipArchive n'est pas install&eacute;e. Impossible de continuer", //zip
	"REDIRECT_MSG"			=> "Si votre navigateur ne vous redirige pas, cliquez <a href=\"%s\">ici</a>", //basic
	"REDIRECT"				=> "Redirection", //basic
	"DENIED"				=> "Refus&eacute;", //sitemap
	"DEBUG_MODE"			=> "Mode DEBUG", //nav-include
	"DOUBLE_CLICK_EDIT"		=> "Double-cliquez pour éditer", //components
	"THUMB_SAVED"			=> "Miniature Sauvegard&eacute;e", //image
	"EDIT_COMPONENTS"		=>	"Modifier ou Ajouter des composants", //components
	"REQS_MORE_INFO"		=> "Pour plus d'informations sur les modules requis, visitez la <a href=\"%s\" target=\"_blank\" >page des pr&eacute;requis</a>.", //install & health-check
	"SYSTEM_UPDATE" 		=> "Système mis &agrave; jour", // update.php
	"AUTHOR" 				=> "Auteur", //plugins.php
	"ENABLE" 				=> "Activer", //plugins.php
	"DISABLE" 				=> "D&eacute;sactiver", //plugins.php
	"NO_THEME_SCREENSHOT" 	=> "Pas d'aper&ccedil;u du th&egrave;me disponible", //theme.php
	"UNSAVED_INFORMATION" 	=> "Vous &ecirc;tes sur le point de quitter cette page et de perdre toutes les informations non sauvegard&eacute;s.", //edit.php
	"BACK_TO_WEBSITE" 		=> "Retour au site", //index & resetpassword
	"SUPPORT_FORUM" 		=> "Forum du Support", //support.php
	"FILTER" 				=> "Filt<em>r</em>e", //pages.php
	"UPLOADIFY_BUTTON" 		=> "Mettre en ligne des fichiers et/ou des images", //upload.php
	"FILE_BROWSER" 			=> "Explorateur de fichiers", //filebrowser.php
	"SELECT_FILE" 			=> "Sélectionner un fichier", //filebrowser.php
	"CREATE_FOLDER" 		=> "Cr&eacute;er un dossier", //upload.php
	"THUMBNAIL" 			=> "Miniature", //filebrowser.php
	"ERROR_FOLDER_EXISTS" 	=> "Le dossier que vous essayez de cr&eacute;er existe d&eacute;j&agrave;", //upload.php
	"FOLDER_CREATED" 		=> "Le nouveau dossier a bien &eacute;t&eacute; cr&eacute;er: <strong>%s</strong>", //upload.php
	"ERROR_CREATING_FOLDER" => "Il y a eu une erreur lors de la cr&eacute;ation du nouveau dossier", //upload.php
	"DELETE_FOLDER" 		=> "Supprimer le dossier", //upload.php
	"FILE_NAME" 			=> "Nom de fichier", //multiple tr header rows
	"FILE_SIZE" 			=> "Taille", //multiple tr header rows
	"ARCHIVE_DATE" 			=> "Date de l'Archive", //archive.php
	"CKEDITOR_LANG" 		=> "fr", // edit.php ; set CKEditor language, don't forget to include CKEditor language file in translation zip

	# new to 3.1 
	"XML_INVALID" 			=> "XML Invalide", //template-functions.php
	"XML_VALID" 			=> "XML Valide",
	"UPDATE_AVAILABLE" 		=> "Mise &agrave; jour disponible", //plugins.php
	"STATUS" 				=> "Etat", //plugins.php
	"CLONE" 				=> "Cloner", //edit.php
	"CLONE_SUCCESS" 		=> "Clonage r&eacute;ussi: %s", //pages.php
	"COPY" 					=> "Copier", //pages.php
	"CLONE_ERROR" 			=> "Il y a un probl&egrave;me dans la tentative de clonage <b>%s</b>",  //pages.php
	"AUTOSAVE_NOTIFY" 		=> 'Page sauvegard&eacute; automatiquement &agrave;', //edit.php
	"MENU_MANAGER" 			=> 'Gestionnaire de <em>M</em>enu', //edit.php
	"GET_PLUGINS_LINK" 		=> 'T&eacute;l&eacute;charger <em>P</em>lus de Plugins',
	"SITEMAP_REFRESHED" 	=> "Votre sitemap a &eacute;t&eacute; rafra&icirc;chi", //edit.php
	"LOG_FILE_EMPTY" 		=> 	"Ce fichier de log est vide", //log.php
	"SHARE" 				=> 	"Partager", //footer.php
	"NO_PARENT" 			=> "Pas de Parent", //edit.php
	"REMAINING" 			=> "caractères restants&nbsp;", //edit.php
	"NORMAL" 				=> "Normal", //edit.php
	"ERR_CANNOT_DELETE" 	=> "Impossible de supprimer %s. SVP faites le manuellement.", //common.php
	"ADDITIONAL_ACTIONS" 	=> "Autres Actions", //edit.php
	"ITEMS" 				=> "éléments", //upload.php
	"SAVE_MENU_ORDER" 		=> "Enregistrer l'ordre du menu", //menu-manager.php
	"MENU_MANAGER_DESC" 	=> "Organisez les éléments du menu par Glisser-d&eacute;poser, puis cliquez sur le bouton <strong>'Enregistrer l'Ordre du menu'</strong>.", //menu-manager.php
	"MENU_MANAGER_SUCCESS" 	=> "Le nouvel ordre du menu a &eacute;t&eacute; sauvegard&eacute;", //menu-manager.php
    ...
    "API_ERR_NOPAGE" 		=> "L'authentification avec l'API est d&egrave;sactiv&egrave;e",
	 ...
	 * Additions for 3.1
	 */
	"DEBUG_CONSOLE" 		=> 'Enregistrer les composants',

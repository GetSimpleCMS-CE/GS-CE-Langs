...
"PLUGINS_MANAGEMENT_INFO"	=> "Alcuni plugin richiedono script js/css aggiuntivi per funzionare correttamente.<br>Assicurati che il plug-in 'modernScript CE' sia abilitato e controlla le impostazioni.",
...
"REDIRECT" => "Reindirizzando", //basic
"DENIED" => "Negato", //sitemap
"DEBUG_MODE" => "DEBUG MODE", //nav-include
"DOUBLE_CLICK_EDIT" => "Doppio clic per modificare", //components
"THUMB_SAVED" => "Miniatura salvata", //image
"EDIT_COMPONENTS" => "Modifica componenti", //components
"REQS_MORE_INFO" => "Per ulteriori informazioni sui moduli richiesti, visita la <a href=\"%s\" target=\"_blank\" >pagina dei requisiti</a>.", //install & health-check
"SYSTEM_UPDATE" => "Aggiornamento di sistema", // update.php
"AUTHOR" => "Autore", //plugins.php
"ENABLE" => "Attiva", //plugins.php
"DISABLE" => "Disattiva", //plugins.php
"NO_THEME_SCREENSHOT" => "Questo tema non ha immagini di anteprima", //theme.php
"UNSAVED_INFORMATION" => "Stai abbandonando questa pagina, tutte le informazioni non salvate andranno perse.", //edit.php
"BACK_TO_WEBSITE" => "Torna al sito", //index & resetpassword
"SUPPORT_FORUM" => "Forum di supporto", //support.php
"FILTER" => "Filtra", //pages.php
"UPLOADIFY_BUTTON" => "Carica file o immagini...", //upload.php
"FILE_BROWSER" => "Sfoglia file", //filebrowser.php
"SELECT_FILE" => "Scegli file", //filebrowser.php
"CREATE_FOLDER" => "Crea cartella", //upload.php
"THUMBNAIL" => "Miniatura", //filebrowser.php
"ERROR_FOLDER_EXISTS" => "Esiste già una cartella con lo stesso nome", //upload.php
"FOLDER_CREATED" => "La cartella è stata creata: <strong>%s</strong>", //upload.php
"ERROR_CREATING_FOLDER" => "Si è verificato un errore nella creazione della cartella", //upload.php
"DELETE_FOLDER" => "Elimina cartella", //upload.php
"FILE_NAME" => "Nome file", //multiple tr header rows
"FILE_SIZE" => "Dimensione", //multiple tr header rows
...
"STATUS" => "Stato", //plugins.php
"CLONE" => "Clona", //edit.php
"CLONE_SUCCESS" => "%s creato con successo", //pages.php
"COPY" => "Copia", //pages.php
"CLONE_ERROR" => "Si è verificato un problema clonando <strong>%s</strong>",  //pages.php
"AUTOSAVE_NOTIFY" => "Pagina salvata automaticamente al", //edit.php
"MENU_MANAGER" => "Gestisci menu", //edit.php
"GET_PLUGINS_LINK" => "Scarica altri plugin",
"SITEMAP_REFRESHED" => "La mappa del sito è stata ricaricata", //edit.php
"LOG_FILE_EMPTY" => "Questo file log è vuoto", //log.php
"SHARE" => "Condividi", //footer.php
"NO_PARENT" => "Nessuna", //edit.php
"REMAINING" => "caratteri rimanenti", //edit.php
"NORMAL" => "Normale", //edit.php
"ERR_CANNOT_DELETE" => "Impossibile eliminare %s. Eliminare manualmente.", //common.php
"ADDITIONAL_ACTIONS" => "Altre azioni", //edit.php
"ITEMS" => "oggetti", //upload.php
...
"API_CONFIRM" => "SEI SICURO?",
	...
	// salt-shaker
	"Security_Generator" 	=> 'Generatore di Sale/Hash di Sicurezza CE',
	"More_info" 			=> 'Maggiori informazioni disponibili nel',
	"Wiki" 					=> 'Wiki',
	"Security_Notice" 		=> 'Avviso di Sicurezza',
	"Tokens_are_never" 		=> 'I token non vengono mai visualizzati e vengono cancellati immediatamente dopo l\'elaborazione.',
	"Password_Hash" 		=> 'Hash della Password',
	"Custom_Salt_Hash" 		=> 'Hash del Sale Personalizzato',
	"Password_Hashing" 		=> 'Hashing della Password',
	"Used_to_enhance" 		=> 'Utilizzato per migliorare la sicurezza delle password degli utenti. Dovrai reimpostare tutte le password una volta aggiunto questo.',
	"Password_Token" 		=> 'Token della Password',
	"Any_word" 				=> 'Qualsiasi parola scegli...',
	"Random_string" 		=> 'Stringa casuale che include caratteri e simboli...',
	"System_Salt" 			=> 'Sale del Sistema',
	"Generate" 				=> 'Genera',
	"Security_Hashing" 		=> 'Hashing di Sicurezza',
	"enhance_system_wide" 	=> 'Utilizzato per migliorare la sicurezza del sistema, inclusi:',
	"temporary_files" 		=> 'Cookie/file temporanei, reset della sessione, protezione CSRF, caricamento di file, ecc.',
	"Input_Token" 			=> 'Token di Input',
	"Application_Salt" 		=> 'Sale dell\'Applicazione',
	"Generate_Hashes" 		=> 'Genera Hash',
	"Password_Hash_Results" => 'Risultati dell\'Hash della Password',
	"hidden" 				=> 'nascosto',
	"SHA1_of_Salt" 			=> 'SHA1 del Sale',
	"Your_Hash" 			=> 'Il tuo Hash \'GSLOGINSALT\'',
	"hash_copied" 			=> 'hash copiato!',
	"Remain_logged" 		=> 'Rimani connesso al tuo account amministratore.',
	"Add_hash_GSLOGINSALT" 	=> 'Aggiungi il nuovo hash al tuo campo \'GSLOGINSALT\' in gsconfig.php.',
	"Update_all" 			=> 'Aggiorna tutte le password degli utenti.',
	"Custom_Salt" 			=> 'Risultati dell\'Hash del Sale Personalizzato',
	"SHA1_of_Application" 	=> 'SHA1 del Sale dell\'Applicazione',
	"Your_Custome_Hash" 	=> 'Il tuo Hash \'GSUSECUSTOMSALT\'',
	"Add_hash_GSUSECUSTOMSALT" 	=> 'Aggiungi il nuovo hash al tuo campo \'GSUSECUSTOMSALT\' in gsconfig.php.',
	"Clear_cookies" 		=> 'Cancella i cookie.',

...
$i18n = [
    ...
    */
    ...
    "PLUGINS_MANAGEMENT_INFO"	=> "Some plugins may require additional js/css scripts to function correctly.<br>Make sure 'modernScript CE' plugin is enabled and check settings.",
	...
	***********************************************************************************/
	...
	// salt-shaker
	"Security_Generator" 	=> 'CE Security Salt/Hash Generator',
	"More_info" 			=> 'More info available in the',
	"Wiki" 					=> 'Wiki',
	"Security_Notice" 		=> 'Security Notice',
	"Tokens_are_never" 		=> 'Tokens are never displayed and are cleared immediately after processing.',
	"Password_Hash" 		=> 'Password Hash',
	"Custom_Salt_Hash" 		=> 'Custom Salt Hash',
	"Password_Hashing" 		=> 'Password Hashing',
	"Used_to_enhance" 		=> 'Used to enhance user password security. You will need to reset all passwords once this is added.',
	"Password_Token" 		=> 'Password Token',
	"Any_word" 				=> 'Any word you choose...',
	"Random_string" 		=> 'Random string including characters and symbols...',
	"System_Salt" 			=> 'System Salt',
	"Generate" 				=> 'Generate',
	"Security_Hashing" 		=> 'Security Hashing',
	"enhance_system_wide" 	=> 'Used to enhance system-wide security, including:',
	"temporary_files" 		=> 'Cookies/temporary files, session reset, CSRF protection, file uploads, etc.',
	"Input_Token" 			=> 'Input Token',
	"Application_Salt" 		=> 'Application Salt',
	"Generate_Hashes" 		=> 'Generate Hashes',
	"Password_Hash_Results" => 'Password Hash Results',
	"hidden" 				=> 'hidden',
	"SHA1_of_Salt" 			=> 'SHA1 of Salt',
	"Your_Hash" 			=> 'Your \'GSLOGINSALT\' Hash',
	"hash_copied" 			=> 'hash copied!',
	"Remain_logged" 		=> 'Remain logged into your admin account.',
	"Add_hash_GSLOGINSALT" 	=> 'Add the new hash to your \'GSLOGINSALT\' field in gsconfig.php.',
	"Update_all" 			=> 'Update all user passwords.',
	"Custom_Salt" 			=> 'Custom Salt Hash Results',
	"SHA1_of_Application" 	=> 'SHA1 of Application Salt',
	"Your_Custome_Hash" 	=> 'Your \'GSUSECUSTOMSALT\' Hash',
	"Add_hash_GSUSECUSTOMSALT" 	=> 'Add the new hash to your \'GSUSECUSTOMSALT\' field in gsconfig.php.',

...
"LABEL_USERNAME"		=>	"Имя пользователя (латынь)",
...
"API_CONFIRM" 			=> "ВЫ УВЕРЕНЫ?",
	...
	// salt-shaker
	"Security_Generator" 	=> 'Генератор соли/хеша безопасности CE',
	"More_info" 			=> 'Дополнительная информация доступна в',
	"Wiki" 					=> 'Вики',
	"Security_Notice" 		=> 'Уведомление о безопасности',
	"Tokens_are_never" 		=> 'Токены никогда не отображаются и удаляются сразу после обработки.',
	"Password_Hash" 		=> 'Хеш пароля',
	"Custom_Salt_Hash" 		=> 'Пользовательский хеш соли',
	"Password_Hashing" 		=> 'Хеширование пароля',
	"Used_to_enhance" 		=> 'Используется для повышения безопасности паролей пользователей. После добавления вам нужно будет сбросить все пароли.',
	"Password_Token" 		=> 'Токен пароля',
	"Any_word" 				=> 'Любое выбранное вами слово...',
	"Random_string" 		=> 'Случайная строка, включая символы и знаки...',
	"System_Salt" 			=> 'Системная соль',
	"Generate" 				=> 'Сгенерировать',
	"Security_Hashing" 		=> 'Хеширование безопасности',
	"enhance_system_wide" 	=> 'Используется для повышения безопасности всей системы, включая:',
	"temporary_files" 		=> 'Куки/временные файлы, сброс сессии, защита от CSRF, загрузка файлов и т.д.',
	"Input_Token" 			=> 'Токен ввода',
	"Application_Salt" 		=> 'Соль приложения',
	"Generate_Hashes" 		=> 'Сгенерировать хеши',
	"Password_Hash_Results" => 'Результаты хеширования пароля',
	"hidden" 				=> 'скрыто',
	"SHA1_of_Salt" 			=> 'SHA1 соли',
	"Your_Hash" 			=> 'Ваш хеш \'GSLOGINSALT\'',
	"hash_copied" 			=> 'хеш скопирован!',
	"Remain_logged" 		=> 'Оставайтесь в системе в своей учетной записи администратора.',
	"Add_hash_GSLOGINSALT" 	=> 'Добавьте новый хеш в поле \'GSLOGINSALT\' в gsconfig.php.',
	"Update_all" 			=> 'Обновить все пароли пользователей.',
	"Custom_Salt" 				=> 'Результаты пользовательского хеширования соли',
	"SHA1_of_Application" 	=> 'SHA1 соли приложения',
